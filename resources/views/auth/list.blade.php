            ...
            <div class="content-inner">
                ...
                <div class="content d-flex justify-content-center align-items-center">
                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="row">
                                <a class="btn btn-dark mt-4" href="{{ route('view.login', ['guard' => 'trainer']) }}"> تسجيل دخول كمدرب </a>
                            </div>
                            <div class="row">
                                <a class="btn btn-dark mt-4" href="{{ route('view.login', ['guard' => 'student']) }}"> تسجيل دخول كطالب </a>
                            </div>
                            <div class="row">
                                <a class="btn btn-dark mt-4" href="{{ route('view.login', ['guard' => 'admin']) }}"> تسجيل دخول مدير </a>
                            </div>
                        </div>
                    </div>
                    <!-- /login form -->
