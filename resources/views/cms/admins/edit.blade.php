...
@section('tittle_1', ' تعديل المشرف ')
@section('tittle_2', ' تعديل المشرف ')
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0"> اضافة مشرف </h6>
                </div>
                <div class="card-body">
                    <form action="#">
                        <div class="mb-3">
                            <label class="form-label">الاسم</label>
                            <input type="text" name="name" id="name" value="{{ $admin->user->name }}"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-control-feedback form-control-feedback-start">
                                <input type="text" class="form-control" name="email" id="email"
                                    value="{{ $admin->email }}" disabled placeholder="john@doe.com">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="mobile" id="mobile" class="form-control"
                                value="{{ $admin->user->mobile }}" placeholder="رقم الهاتف">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="الحالة" name="status" id="status"
                                    ...
                                    <option value="married" {{ $admin->status == 'married ' ? selected : null }}>متزوج
                                    </option>
                                    <option value="single" {{ $admin->status == 'single ' ? selected : null }}>اعزب
                                    </option>
                                    <option value="separated" {{ $admin->status == 'separated ' ? selected : null }}>مطلق
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-lg-9">
                                <select data-placeholder="الجنس" name="gender" id="gender"
                                    class="form-control select-icons">
                                    <option value="male" {{ $admin->gender == 'male ' ? selected : null }}>ذكر</option>
                                    <option value="female" {{ $admin->gender == 'female ' ? selected : null }}>انثى
                                    </option>
                                </select>
                            </div>
                        </div>
